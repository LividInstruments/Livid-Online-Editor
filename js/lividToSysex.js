...
lividToSx[7]={
	4: function(){
		var pos=[28,24,20,16,12,8,4,0,30,26,22,18,14,10,6,2,28,24,20,16,12,8,4,0,30,26,22,18,14,10,6,2,29,25,21,17,13,9,5,1,31,27,23,19,15,11,7,3,29,25,21,17,13,9,5,1,31,27,23,19,15,11,7,3,37,37,33,33,35,35,39,39,38,38,32,34,36,32,34,36,40];
		CNO=4;
		cntl="led";
		...
		//need to step thru ids in a weird order so the right halves of the bytes can be joined. 
 		var idorder = [7,23,39,55,15,31,47,63,6,22,38,54,14,30,46,62,5,21,37,53,13,29,45,61,4,20,36,52,12,28,44,60,3,19,35,51,11,27,43,59,2,18,34,50,10,26,42,58,1,17,33,49,9,25,41,57,0,16,32,48,8,24,40,56,74,77,66,67,75,78,68,69,76,79,64,65,73,72,71,70,80];
		var btnct=81;
