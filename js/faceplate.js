...
"btn_31" : R.rect(633.5 , 350.5 , 32 , 32, 10).attr(attr)
  ...
  "btn_27" : R.path("M734.491,76.459c0,0.92-1.119,1.666-2.5,1.666h-13c-1.381,0-2.5-0.746-2.5-1.666v-5.668c0-0.92,1.119-1.666,2.5-1.666h13c1.381,0,2.5,0.746,2.5,1.666V76.459z").attr(attr),
  "btn_26" : R.path("M662.491,148.459c0,0.92-1.119,1.666-2.5,1.666h-13c-1.381,0-2.5-0.746-2.5-1.666v-5.668c0-0.92,1.119-1.666,2.5-1.666h13c1.381,0,2.5,0.746,2.5,1.666V148.459z").attr(attr),
  ...
  "pot_52" : R.path("M704.829,551.613h-10.648V478h-9.383v73.613h-10.736c-0.34,0-0.615,1.297-0.615,2.893v50.484c0,1.596,0.275,2.891,0.615,2.891h10.736V685h9.383v-77.119h10.648c0.34,0,0.617-1.295,0.617-2.891v-50.484C705.446,552.91,705.169,551.613,704.829,551.613z").attr(attr),
  "pot_51" : R.circle(725.491 , 257.5 , 18).attr(attr),
  "pot_50" : R.circle(653.491 , 257.5 , 18).attr(attr),
  "pot_49" : R.circle(725.491 , 185.5 , 18).attr(attr),		
  "pot_48" : R.circle(653.491 , 185.5 , 18).attr(attr),
  ...
  "pot_46" : R.circle(545.491 , 329.5 , 18).attr(attr),
  "pot_45" : R.circle(545.491 , 257.5 , 18).attr(attr),
  "pot_44" : R.circle(545.491 , 185.5 , 18).attr(attr),
  "pot_43" : R.circle(545.491 , 113.5 , 18).attr(attr),
  "pot_42" : R.circle(545.491 , 41.5 , 18).attr(attr),
  "pot_41" : R.path("M488.829,551.613h-10.648V478h-9.383v73.613h-10.736c-0.34,0-0.615,1.297-0.615,2.893v50.484c0,1.596,0.275,2.891,0.615,2.891h10.736V685h9.383v-77.119h10.648c0.34,0,0.617-1.295,0.617-2.891v-50.484C489.446,552.91,489.169,551.613,488.829,551.613z").attr(attr),
  "pot_40" : R.circle(473.491 , 329.5 , 18).attr(attr),
  "pot_39" : R.circle(473.491 , 257.5 , 18).attr(attr),
  "pot_38" : R.circle(473.491 , 185.5 , 18).attr(attr),
  "pot_37" : R.circle(473.491 , 113.5 , 18).attr(attr),
  "pot_36" : R.circle(473.491 , 41.5 , 18).attr(attr),
  "pot_35" : R.path("M416.829,551.613h-10.648V478h-9.383v73.613h-10.736c-0.34,0-0.615,1.297-0.615,2.893v50.484c0,1.596,0.275,2.891,0.615,2.891h10.736V685h9.383v-77.119h10.648c0.34,0,0.617-1.295,0.617-2.891v-50.484C417.446,552.91,417.169,551.613,416.829,551.613z").attr(attr),
  "pot_34" : R.circle(401.491 , 329.5 , 18).attr(attr),
  "pot_33" : R.circle(401.491 , 257.5 , 18).attr(attr),
  "pot_32" : R.circle(401.491 , 185.5 , 18).attr(attr),
  "pot_31" : R.circle(401.491 , 113.5 , 18).attr(attr),
  "pot_30" : R.circle(401.491 , 41.5 , 18).attr(attr),
  "pot_29" : R.path("M344.829,551.613h-10.648V478h-9.383v73.613h-10.736c-0.34,0-0.615,1.297-0.615,2.893v50.484c0,1.596,0.275,2.891,0.615,2.891h10.736V685h9.383v-77.119h10.648c0.34,0,0.617-1.295,0.617-2.891v-50.484C345.446,552.91,345.169,551.613,344.829,551.613z").attr(attr),
  "pot_28" : R.circle(329.491 , 329.5 , 18).attr(attr),
  "pot_27" : R.circle(329.491 , 257.5 , 18).attr(attr),
  "pot_26" : R.circle(329.491 , 185.5 , 18).attr(attr),
  "pot_25" : R.circle(329.491 , 113.5 , 18).attr(attr),
  "pot_24" : R.circle(329.491 , 41.5 , 18).attr(attr),
  "pot_23" : R.path("M272.83,551.613H262.18V478h-9.382v73.613h-10.736c-0.34,0-0.617,1.297-0.617,2.893v50.484c0,1.596,0.276,2.891,0.617,2.891h10.736V685h9.382v-77.119h10.649c0.34,0,0.616-1.295,0.616-2.891v-50.484C273.446,552.91,273.169,551.613,272.83,551.613z").attr(attr),
  "pot_22" : R.circle(257.491 , 329.5 , 18).attr(attr),
  "pot_21" : R.circle(257.491 , 257.5 , 18).attr(attr),
  "pot_20" : R.circle(257.491 , 185.5 , 18).attr(attr),
  "pot_19" : R.circle(257.491 , 113.5 , 18).attr(attr),
  "pot_18" : R.circle(257.491 , 41.5 , 18).attr(attr),
  "pot_17" : R.path("M200.829,551.613H190.18V478h-9.382v73.613h-10.736c-0.34,0-0.617,1.297-0.617,2.893v50.484c0,1.596,0.276,2.891,0.617,2.891h10.736V685h9.382v-77.119h10.649c0.34,0,0.617-1.295,0.617-2.891v-50.484C201.446,552.91,201.169,551.613,200.829,551.613z").attr(attr),
  "pot_16" : R.circle(185.491 , 329.5 , 18).attr(attr),
  "pot_15" : R.circle(185.491 , 257.5 , 18).attr(attr),
  "pot_14" : R.circle(185.491 , 185.5 , 18).attr(attr),
  "pot_13" : R.circle(185.491 , 113.5 , 18).attr(attr),
  "pot_12" : R.circle(185.491 , 41.5 , 18).attr(attr),
  "pot_11" : R.path("M127.829,551.613H117.18V478h-9.382v73.613H97.062c-0.34,0-0.617,1.297-0.617,2.893v50.484c0,1.596,0.276,2.891,0.617,2.891h10.736V685h9.382v-77.119h10.649c0.34,0,0.617-1.295,0.617-2.891v-50.484C128.446,552.91,128.169,551.613,127.829,551.613z").attr(attr),
  "pot_10" : R.circle(112.491 , 329.5 , 18).attr(attr),
  "pot_9" : R.circle(112.491 , 257.5 , 18).attr(attr),
  "pot_8" : R.circle(112.491 , 185.5 , 18).attr(attr),
  "pot_7" : R.circle(112.491 , 113.5 , 18).attr(attr),
  "pot_6" : R.circle(112.491 , 41.5 , 18).attr(attr),
  "pot_5" : R.path("M56.829,551.613H46.18V478h-9.382v73.613H26.062c-0.34,0-0.617,1.297-0.617,2.893v50.484c0,1.596,0.276,2.891,0.617,2.891h10.736V685h9.382v-77.119h10.649c0.34,0,0.617-1.295,0.617-2.891v-50.484C57.446,552.91,57.169,551.613,56.829,551.613z").attr(attr),
