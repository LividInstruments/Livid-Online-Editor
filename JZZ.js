(function() { // function jzz?
  ...
  function _tryJazzPlugin() {
    ...
    console.log("tryJazzPlugin: before initJazz");
    if (obj.isJazz) {
      _initJazzPlugin(obj);
      return;
    }
    console.log("tryJazzPlugin: after initJazz")    
    this._break();
  }
  // Web MIDI API
  ...
  function _filterEngines(opt) {
    console.log("_filterEngines (Start)");
    ...
    ret.push(_initNONE);
    console.log("_filterEngines (End)");
    return ret;
  }
  ...
  function _initJazzPlugin(obj) {
    console.log("initJazzPlugin(Start)");    
    ...
    _engine._newPlugin = function() {
      ...
      console.log("initJazzPlugin(End)");    
      return plg.isJazz ? plg : undefined;
    }
    _initEngineJP();
    console.log("initEngine(Post)");    
  }
  function _initWebMIDI(access, sysex) {
    console.log("initWebMidi(Start)");    
